import { U as jsxRuntimeExports, T as React, r as reactExports } from "./worker-entry-BBPuhNZi.js";
import { o as objectType, b as booleanType, s as stringType, a as enumType, L as Link, c as Route, e as events, t as toast } from "./router-B8zQIBMN.js";
...
function formatEventDate$1(isoDate) {
...
function RegisterEventSummary({ event }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-4 rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-semibold text-white", children: event.title }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 space-y-1 text-sm text-[#A3B5A8]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-4 w-4" }),
        formatEventDate$1(event.date)
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-center gap-2", children: [
...
const categoryLevelTone = {
  Low: {
    idle: "border-emerald-400/20 bg-emerald-400/5 text-emerald-200",
    active: "border-emerald-300 bg-emerald-400/15 text-emerald-100 shadow-[0_0_18px_rgba(16,185,129,0.25)]"
  },
  Medium: {
    idle: "border-yellow-400/20 bg-yellow-400/5 text-yellow-200",
    active: "border-yellow-300 bg-yellow-400/15 text-yellow-100 shadow-[0_0_18px_rgba(250,204,21,0.25)]"
  },
  High: {
...
const categorySchema$1 = enumType(["Low", "Medium", "High"], {
  required_error: "Wybierz poziom trudności",
  invalid_type_error: "Wybierz poziom trudności"
});
const registerSchema = objectType({
  email: stringType().trim().email("Nieprawidłowy adres e-mail"),
  patrolPhone: stringType().trim().min(9, "Nieprawidłowy numer telefonu").refine((value) => /^(\+48)?\s?\d{3}\s?\d{3}\s?\d{3}$/.test(value.replace(/-/g, "")), {
    message: "Nieprawidłowy numer telefonu"
  }),
  teamName: stringType().trim().min(3, "Podaj nazwę patrolu"),
  teamMembers: stringType().trim().min(3, "Podaj skład patrolu"),
  category: categorySchema$1,
  terms: booleanType().refine((value) => value, {
    message: "Musisz zaakceptować regulamin"
  }),
  privacyPolicy: booleanType().refine((value) => value, {
...
function ErrorText({ message }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-center gap-1.5 text-xs text-[#FF6B00]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-3.5 w-3.5 shrink-0" }),
    message
  ] });
}
function RegisterForm({ event, preselectedCategory, onSubmit }) {
  const {
    register,
    handleSubmit,
    watch,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit(onSubmit), noValidate: true, className: "space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold tracking-tight text-white", children: "Zgłoszenie do biegu" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-[#A3B5A8]", children: "Uzupełnij dane i wybierz kategorię." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorText, { message: errors.email?.message })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "label",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorText, { message: errors.patrolPhone?.message })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "label",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorText, { message: errors.teamName?.message })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "label",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorText, { message: errors.teamMembers?.message })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold tracking-widest text-[#A3B5A8] uppercase", children: "POZIOM TRUDNOŚCI" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3", children: categoryOrder.map((level) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            disabled: isDisabled,
            onClick: () => setValue("category", level, {
              shouldValidate: true,
              shouldTouch: true,
              shouldDirty: true
            }),
            className: `rounded-2xl border p-4 text-center transition-all ${isDisabled ? "cursor-not-allowed border-white/10 bg-white/5 text-white/30" : `cursor-pointer ${toneClass.idle}`} ${isActive && !isDisabled ? toneClass.active : ""}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-bold", children: level }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-[#A3B5A8]", children: isDisabled ? "Brak miejsc" : `${spotsLeft} miejsc` })
            ]
          },
          level
        );
      }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorText, { message: errors.category?.message })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        {
          type: "button",
          onClick: () => setValue("terms", !acceptedTerms, {
            shouldValidate: true,
            shouldTouch: true,
            shouldDirty: true
          }),
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: `mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded border ${acceptedTerms ? "border-[#00FF66] bg-[#00FF66]" : "border-white/20 bg-transparent"}`,
                children: acceptedTerms ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-3.5 w-3.5 text-white" }) : null
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm text-[#A3B5A8]", children: [
              "Akceptuję",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorText, { message: errors.terms?.message }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          onClick: () => setValue("privacyPolicy", !acceptedPrivacy, {
            shouldValidate: true,
            shouldTouch: true,
            shouldDirty: true
          }),
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: `mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded border ${acceptedPrivacy ? "border-[#00FF66] bg-[#00FF66]" : "border-white/20 bg-transparent"}`,
                children: acceptedPrivacy ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-3.5 w-3.5 text-white" }) : null
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm text-[#A3B5A8]", children: [
              "Akceptuję",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorText, { message: errors.privacyPolicy?.message })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          isSubmitting ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-5 w-5 animate-spin" }) : null,
...
function RegisterSuccess({ event, successData }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "space-y-5 text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "mx-auto h-16 w-16 text-[#00FF66]" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-white", children: "Zgłoszenie przyjęte!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-[#A3B5A8]", children: "Potwierdzenie zostanie wysłane na podany adres e-mail." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 rounded-2xl border border-white/10 bg-white/5 p-4 text-left", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-[#A3B5A8]", children: [
        "Nazwa patrolu: ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-white", children: successData.teamName })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-[#A3B5A8]", children: [
        "Email: ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-white", children: successData.email })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-[#A3B5A8]", children: [
        "Telefon patrolowego:",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-white", children: successData.patrolPhone })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-[#A3B5A8]", children: [
        "Poziom:",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            ...
            children: successData.category
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-[#A3B5A8]", children: [
        "Wydarzenie: ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-white", children: event.title })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-[#A3B5A8]", children: [
        "Data: ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-white", children: formatEventDate(event.date) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-[#A3B5A8]", children: [
        "Skład patrolu: ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-white", children: successData.teamMembers })
      ] })
    ] }),
...
const categorySchema = enumType(["Low", "Medium", "High"]);
objectType({
...
function EventRegisterPage() {
  ...
  const preselectedCategory = reactExports.useMemo(() => {
    ...
    return spotsLeft > 0 ? selected.name : void 0;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-dvh bg-black/45", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "mx-auto w-full max-w-5xl px-6 pt-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/events/$id", params: {
        id: event.id
      }, className: "inline-flex text-sm text-white/70 transition-colors hover:text-white", children: "← Szczegóły biegu" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto mt-3 w-full max-w-lg pb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(RegisterEventSummary, { event }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mt-5 rounded-3xl border border-white/10 bg-white/5 p-6 shadow-xl backdrop-blur-xl [box-shadow:inset_0_1px_0_rgba(255,255,255,0.05),0_20px_60px_rgba(0,0,0,0.4)]", children: !submitSuccess ? /* @__PURE__ */ jsxRuntimeExports.jsx(RegisterForm, { event, preselectedCategory, onSubmit }) : /* @__PURE__ */ jsxRuntimeExports.jsx(RegisterSuccess, { event, successData: submitSuccess }) })
      ] })
    ] })
  ] });
}
export {
  EventRegisterPage as component
};
