...
const appCss = "/ino/assets/styles-DJ0xEYux.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-black/45 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-7xl font-bold text-white", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-4 text-xl font-semibold text-white", children: "Chyba się pogubiłeś" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-forest", children: "Ścieżka której szukasz nie istnieje, następnym razem użyj kompasu!" }),
...
const Route$5 = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Tradycyjna nawigacja, cyfrowe wyniki. Wybierz trasę, śledź wyniki na żywo i ruszaj w las."
      },
      ...
      {
        property: "og:image",
        content: "https://storage.googleapis.com/gpt-engineer-file-uploads/zQy26wnPkVOevkYS3VQMavfKKKm1/social-images/social-1777377912875-ino_lampion.webp"
      },
      {
        name: "twitter:image",
        content: "https://storage.googleapis.com/gpt-engineer-file-uploads/zQy26wnPkVOevkYS3VQMavfKKKm1/social-images/social-1777377912875-ino_lampion.webp"
...
function RootShell({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { lang: "pl", className: "dark", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("head", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(HeadContent, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("body", { className: "text-white antialiased", children: [
      children,
...
const $$splitComponentImporter$4 = () => import("./live-DV-y7Xbq.js");
const Route$4 = createFileRoute("/live")({
  head: () => ({
    meta: [{
      title: "Wyniki na żywo — Impreza na Orientację"
    }, {
      name: "description",
      content: "Śledź wyniki biegów na orientację na żywo. Klasyfikacja w kategoriach Low, Medium i High."
    }, {
      property: "og:title",
      content: "Wyniki na żywo — Impreza na Orientację"
    }, {
      property: "og:description",
...
const $$splitComponentImporter$3 = () => import("./events-HuTT3FYr.js");
const Route$3 = createFileRoute("/events")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Lista nadchodzących biegów na orientację. Wybierz wydarzenie i zapisz się online."
    }, {
      property: "og:title",
      content: "Nadchodzące biegi — Impreza na Orientację"
    }, {
      property: "og:description",
...
const $$splitComponentImporter$2 = () => import("./index-B7oSdTM4.js");
const Route$2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "W aplikacji InO sprawdzisz najbliższe imprezy, szczegóły tras i wyniki na żywo - wszystko w jednym miejscu."
    }, {
      property: "og:title",
      content: "Impreza na Orientację"
    }, {
      property: "og:description",
...
const $$splitComponentImporter$1 = () => import("./events._id-BJkeCg-R.js");
const Route$1 = createFileRoute("/events/$id")({
...
const $$splitComponentImporter = () => import("./events._id.register-Cc0ZkOEC.js");
const categorySchema = enumType(["Low", "Medium", "High"]);
const searchSchema = objectType({
  category: categorySchema.optional()
});
const Route2 = createFileRoute("/events/$id/register")({
...
const LiveRoute = Route$4.update({
  id: "/live",
  path: "/live",
...
const EventsIdRoute = Route$1.update({
  id: "/$id",
  path: "/$id",
  getParentRoute: () => EventsRoute
});
const EventsIdRegisterRoute = Route2.update({
  id: "/register",
  path: "/register",
  getParentRoute: () => EventsIdRoute
});
const EventsIdRouteChildren = {
  EventsIdRegisterRoute
};
